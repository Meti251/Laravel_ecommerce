...
<head>
  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
		...
		<!-- Bootstrap CSS -->
		<link href="{{ asset('tools/css/bootstrap.min.css')}}" rel="stylesheet">
		<link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" rel="stylesheet">
		<link href="{{ asset('tools/css/tiny-slider.css')}}" rel="stylesheet">
		<link href="{{ asset('tools/css/style.css')}}" rel="stylesheet">
	...
	<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					<ul class="custom-navbar-nav navbar-nav ms-auto mb-2 mb-md-0">
						...
						<li><a class="nav-link" href="{{route('customer.services')}}">Services</a></li>
						<li><a class="nav-link" href="{{route('customer.blog')}}">Blog</a></li>
						<li><a class="nav-link" href="{{route('customer.contact')}}">Contact us</a></li>
					</ul>

					<ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
						<li><a class="nav-link" href="#"><img src="{{asset('tools/images/user.svg')}}"></a></li>
						<li><a class="nav-link" href="{{route('customer.cart')}}"><img src="{{asset('tools/images/cart.svg')}}"></a></li>
					</ul>
				</div>
			</div>
					...
					<div class="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
						<a class="product-item" href="cart.html">
							...
							<span class="icon-cross">
								<img src="{{asset('tools/images/cross.svg')}}" class="img-fluid">
							</span>
						</a>
					</div>
					<!-- End Column 2 -->
					...
					<div class="col-lg-6">
						...
						<div class="row my-5">
							...
							<div class="col-6 col-md-6">
								<div class="feature">
									<div class="icon">
										<img src="{{asset('tools/images/bag.svg')}}" alt="Image" class="imf-fluid">
									</div>
									<h3>Easy to Shop</h3>
									<p>Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit. Aliquam vulputate.</p>
								</div>
							...
							<div class="col-6 col-md-6">
								<div class="feature">
									<div class="icon">
										<img src="{{asset('tools/images/support.svg')}}" alt="Image" class="imf-fluid">
									</div>
									<h3>24/7 Support</h3>
									<p>Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit. Aliquam vulputate.</p>
								</div>
							...
							<div class="col-6 col-md-6">
								<div class="feature">
									<div class="icon">
										<img src="{{asset('tools/images/return.svg')}}" alt="Image" class="imf-fluid">
									</div>
											...
											<div class="testimonial-block text-center">
												...
												<div class="author-info">
													<div class="author-pic">
														<img src="{{asset('tools/images/person-1.png')}}" alt="Maria Jones" class="img-fluid">
													</div>
				...
				<div class="row">
					<div class="col-lg-8">
						<div class="subscription-form">
							<h3 class="d-flex align-items-center"><span class="me-1"><img src="{{asset('tools/images/envelope-outline.svg')}}" alt="Image" class="img-fluid"></span><span>Subscribe to Newsletter</span></h3>
		...
		<script src="{{asset('tools/js/bootstrap.bundle.min.js')}}"></script>
		<script src="{{asset('tools/js/tiny-slider.js')}}"></script>
		<script src="{{asset('tools/js/custom.js')}}"></script>
	</body>
